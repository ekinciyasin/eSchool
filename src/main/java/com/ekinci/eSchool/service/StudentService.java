...
public class StudentService {
    ...
    public Student updateStudent(Long id, Student updatedStudent) {
        ...
        Optional.of(updatedStudent.getFirstName()).ifPresent(existingStudent::setFirstName);
        Optional.of(updatedStudent.getLastName()).ifPresent(existingStudent::setLastName);
